...
/// <summary>
/// Formats console text as Unity rich text.
/// </summary>
public sealed class UnityRichTextConsoleFormatter : IConsoleTextFormatter
{
    /// <inheritdoc />
    public string Format(ConsoleText text, ConsoleFormattingContext context)
    {
        return ConsoleTextFormatting.Format(text, context, ConsoleTextFormatting.EscapeXmlLike, Open, Close);
    }
